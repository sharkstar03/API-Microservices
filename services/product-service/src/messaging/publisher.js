...
/**
 * Publica un evento relacionado con productos
 * @param {string} routingKey - Clave de enrutamiento (ej: 'product.created')
 * @param {Object} data - Datos del evento
 */
const publishProductEvent = async (routingKey, data) => {
  try {
